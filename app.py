"""
ASISTENTE TÉCNICO SATGARDEN V2.15
Implementación completa de todas las funcionalidades con el layout de lista.
- FIX: Menú principal en formato de lista para evitar bugs de la plataforma.
- Ocultada la barra lateral en la página principal (Hub) para una interfaz más limpia.
...
load_dotenv()
st.set_page_config(page_title="Asistente Satgarden V2.15", page_icon="🛠️", layout="wide")
...
def render_hub_page():
    st.title("🛠️ Asistente Técnico Satgarden V2.13")
    st.markdown("""
